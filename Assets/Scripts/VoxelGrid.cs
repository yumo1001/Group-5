...
public class VoxelGrid
{
    ...
    private PatternType _currentPattern = PatternType.PatternC;
    ...
    public Dictionary<PatternType, GameObject> GOPatternPrefabs
    {
        get
        {
            if (_goPatternPrefabs == null)
            {
                ...
                _goPatternPrefabs.Add(PatternType.PatternC, Resources.Load("Prefabs/PrefabVoxel3") as GameObject);
                _goPatternPrefabs.Add(PatternType.PatternB, Resources.Load("Prefabs/PrefabVoxel2") as GameObject);
            }
